...
// Mechanical machines
crafting.remove("extrautils2:crafter")
crafting.remove("extrautils2:miner")
crafting.remove("extrautils2:user")

crafting.shapedBuilder()
    .mirrored()
    .name("tier3/xu2/crafter")
    .output(item("extrautils2:crafter"))
    .matrix("CTC", "DLR", "CRC")
    .key("C", item("extrautils2:compressedcobblestone"))
    .key("T", item("minecraft:crafting_table"))
    .key("D", item("minecraft:dispenser"))
    .key("L", item("immersiveengineering:metal_decoration0", 4))
...
crafting.shapedBuilder()
    .mirrored()
    .name("tier3/xu2/user")
    .output(item("extrautils2:user"))
    .matrix("CTC", "DLR", "CRC")
    .key("C", item("extrautils2:compressedcobblestone"))
    .key("T", item("rftools:button_module"))
    .key("D", item("minecraft:dispenser"))
    .key("L", item("immersiveengineering:metal_decoration0", 4))
    .key("R", item("minecraft:redstone"))
    .register()
...
crafting.shapedBuilder()
    .mirrored()
    .name("tier3/xu2/miner")
    .output(item("extrautils2:miner"))
    .matrix("CTC", "DLR", "CRC")
    .key("C", item("extrautils2:compressedcobblestone"))
    .key("T", item("calculator:endforgedpickaxe"))
    .key("D", item("minecraft:dispenser"))
    .key("L", item("immersiveengineering:metal_decoration0", 4))
    .key("R", item("minecraft:redstone"))
    .register()
