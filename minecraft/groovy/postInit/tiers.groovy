...
TooltipEvents.setTierName(13, "Constructing Fallout")
TooltipEvents.setUnlock(item("abyssalcraft:shadowgem"), 13)

TooltipEvents.setTierName(14, "Fabled Convergence")
