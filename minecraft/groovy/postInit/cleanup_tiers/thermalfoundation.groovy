...
def elementalDrops = []
for (int i in [1024, 1025, 1026, 1027, 2048, 2049, 2050, 2051, 2052, 2053]) elementalDrops.add(mitem("material", i))
...
for (def it in rocketryItems) TooltipEvents.setTier(it, 10)
