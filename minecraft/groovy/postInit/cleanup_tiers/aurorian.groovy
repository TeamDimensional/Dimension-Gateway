...
for (def it in runestoneLoot) TooltipEvents.setTooltip(it, "tooltip.gateway.loot.aurorian_runestone")
for (def it in darkstoneLoot) TooltipEvents.setTooltip(it, "tooltip.gateway.loot.aurorian_darkstone")
for (def it in moonTempleLoot) TooltipEvents.setTooltip(it, "tooltip.gateway.loot.aurorian_moon")
