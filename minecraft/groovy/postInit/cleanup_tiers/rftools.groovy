...
def tier3Items = [
    ...
    mitem("relay"), mitem("liquid_monitor"), mitem("item_filter"), mitem("elevator"), mitem("button_module"),
]
...
def tier6Items = [
    ...
    mitem("redstone_transmitter_block"), mitem("redstone_receiver_block"), mitem("simple_dialer"), mitem("level_emitter"),
]
