...
for (def it in stellarEquipment) TooltipEvents.setTier(it, 12)
...
mods.enderio.vat.recipeBuilder()
    ...
    .output(fluid("hootch"))
    .baseMultiplier(0.25)
    .itemInputLeft(item("minecraft:poisonous_potato"), 8)
    .itemInputLeft(item("minecraft:potato"), 4)
    .itemInputLeft(item("minecraft:apple"), 3.5)
    .itemInputLeft(item("minecraft:wheat"), 2.5)
    .itemInputRight(item("minecraft:sugar"), 1)
    .itemInputRight(item("minecraft:melon"), 0.4)
    .energy(10000)
    .register()

// Rewrite Cloud Seed recipe because it causes client crashes due to a bug I cannot understamd.
mods.enderio.vat.remove(fluid("cloud_seed"))
mods.enderio.vat.recipeBuilder()
    .input(fluid("water"))
    .output(fluid("cloud_seed"))
    .baseMultiplier(1.0)
    .itemInputLeft(item("thermalfoundation:material", 66), 3.5)
    .itemInputLeft(item("minecraft:clay_ball"), 0.5)
    .itemInputLeft(item("minecraft:clay"), 2)
    .itemInputRight(item("minecraft:snowball"), 0.1)
    .itemInputRight(item("minecraft:snow"), 0.5)
    .itemInputRight(item("minecraft:ice"), 0.5)
    .itemInputRight(item("minecraft:packed_ice"), 1.0)
    .energy(10000)
    .register()
