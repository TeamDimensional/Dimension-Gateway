...
def tier3Items = [
    mitem("gold_upgrade"), mitem("redstone_upgrade"), mitem("fluid_1"), mitem("fluid_2"), mitem("fluid_4"),
    bitem("backpack_iron"), bitem("pickup_upgrade"), bitem("filter_upgrade"),
]
...
def tier5Items = [
    mitem("netherite_upgrade"), bitem("backpack_gold"), bitem("advanced_pickup_upgrade"), bitem("feeding_upgrade"),
    bitem("advanced_deposit_upgrade"), bitem("advanced_restock_upgrade"), bitem("advanced_filter_upgrade"),
]

def tier6Items = [
    bitem("backpack_diamond"), bitem("stack_upgrade_tier_2"), bitem("advanced_feeding_upgrade"),
]

def tier7Items = [
    mitem("ender_drawer"), mitem("armory_cabinet"), bitem("stack_upgrade_tier_3"),
]

def tier8Items = [
    bitem("backpack_obsidian"),
]

def tier10Items = [
    bitem("stack_upgrade_tier_4"), bitem("exponential_stack_upgrade"), bitem("inception_upgrade"),
]
