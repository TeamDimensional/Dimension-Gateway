...
def hideFromJei = [
    ...
    mitem("fluid_output"), mitem("energy_input"), mitem("energy_output"), mitem("projecte_emc.any"),
    mitem("dummy_component"), mitem("item_nbt.any"), mitem("item.any"), mitem("ember.any"),
    mitem("qmd_particle.any"), mitem("item_durability.any"), mitem("ta_impetus.any"), mitem("forge_energy.any"),
