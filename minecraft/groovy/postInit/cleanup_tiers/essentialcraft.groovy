...
for (def it in inqDrops) TooltipEvents.setTooltip(it, "tooltip.gateway.obtain.inquisitorium")
for (def it in hoannaLoot) TooltipEvents.setTooltip(it, "tooltip.gateway.loot.hoanna_dungeon")
for (def it in hoannaBuildingLoot) TooltipEvents.setTooltip(it, "tooltip.gateway.loot.hoanna_ruins")
TooltipEvents.setTooltip(mitem("research_book"), "tooltip.gateway.warn.akashic_ec4")
for (def it in 0..15) TooltipEvents.setTooltip(mitem("essence", it), "tooltip.gateway.obtain.crystal_essence")
TooltipEvents.setTooltip(mitem("elementalsword"), "tooltip.gateway.obtain.ec4_ember_sword")
