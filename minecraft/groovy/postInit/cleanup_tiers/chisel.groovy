...
for (def i in 0..6) TooltipEvents.setTier(mitem("blockcobalt", i), 6)
for (def i in 0..6) TooltipEvents.setTier(mitem("blockplatinum", i), 8)
for (def i in 0..6) TooltipEvents.setTier(mitem("blockuranium", i), 10)
