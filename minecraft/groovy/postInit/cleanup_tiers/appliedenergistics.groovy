...
def eliteItems = [mitem("material", 59)]
...
def removeRecipes = [
    mitem("sky_compass"), mitem("charged_staff"), mitem("portable_cell"), item("nae2:reconstruction_chamber"),
]

def hideFromJei = [
    mitem("facade"), mitem("material", 1), mitem("material", 5), mitem("material", 19), mitem("material", 21), mitem("part", 301),
] + removeRecipes
