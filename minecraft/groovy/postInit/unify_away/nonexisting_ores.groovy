...
ore("oreCopper").remove(item("factorytech:ore"))
...
ore("oreNickel").remove(item("factorytech:ore", 1))
...
GatewayHelpers.hide(item("factorytech:ore"))
GatewayHelpers.hide(item("factorytech:ore", 1))
