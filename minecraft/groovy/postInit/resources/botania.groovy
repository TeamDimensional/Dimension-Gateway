...
mods.botania.rune_altar.recipeBuilder()
    .input(manaPowder, manaSteel, item("essentialcraft:elementalfuel", 1), item("roots:dewgonia"), item("minecraft:reeds"), item("actuallyadditions:item_crystal_empowered", 1))
    .output(item("botania:rune", 0) * 3)
    .mana(t1Cost)
    .register()
// Fire
mods.botania.rune_altar.recipeBuilder()
    .input(manaPowder, manaSteel, item("essentialcraft:elementalfuel", 0), item("roots:infernal_bulb"), item("immersiveengineering:material", 6), item("actuallyadditions:item_crystal_empowered"))
    .output(item("botania:rune", 1) * 3)
    .mana(t1Cost)
    .register()
// Earth
mods.botania.rune_altar.recipeBuilder()
    .input(manaPowder, manaSteel, item("essentialcraft:elementalfuel", 2), item("roots:stalicripe"), item("prodigytech:charred_cobblestone"), item("actuallyadditions:item_crystal_empowered", 4))
    .output(item("botania:rune", 2) * 3)
    .mana(t1Cost)
    .register()
// Air
mods.botania.rune_altar.recipeBuilder()
    .input(manaPowder, manaSteel, item("essentialcraft:elementalfuel", 3), item("roots:cloud_berry"), item("roots:mystic_feather"), item("actuallyadditions:item_crystal_empowered", 5))
    .output(item("botania:rune", 3) * 3)
    .mana(t1Cost)
    .register()
...
// Lust
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 2), item("botania:rune", 4), item("minecraft:potion").withNbt(["Potion": "extrautils2:xu2.love"]), item("thaumcraft:tallow"), item("xreliquary:mob_ingredient", 11))
    .output(item("botania:rune", 9))
    .mana(t3Cost)
    .register()
// Gluttony
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 3), item("botania:rune", 7), item("thermalfoundation:fertilizer", 2), item("botania:manacookie"), item("xreliquary:glowing_bread"))
    .output(item("botania:rune", 10))
    .mana(t3Cost)
    .register()
// Greed
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 2), item("botania:rune", 6), item("thermalfoundation:material", 134), item("minecraft:golden_apple", 1), item("ee:star_shard"))
    .output(item("botania:rune", 11))
    .mana(t3Cost)
    .register()
// Sloth
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune"), item("botania:rune", 5), item("minecraft:potion").withNbt(["Potion": "minecraft:slowness"]), item("essentialcraft:genitem", 32), item("circulation_networks:endercore_crystal"))
    .output(item("botania:rune", 12))
    .mana(t3Cost)
    .register()
// Wrath
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 1), item("botania:rune", 7), item("soot:mug").withNbt(["Fluid": ["Amount": 250, "FluidName": "dwarven_ale"]]), item("netherized:netherite_sword"), item("minecraft:nether_star"))
    .output(item("botania:rune", 13))
    .mana(t3Cost)
    .register()
// Envy
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 3), item("botania:rune", 4), item("essentialcraft:genitem", 55), item("essentialcraft:genitem", 22), item("gateway:ilium_shard"))
    .output(item("botania:rune", 14))
    .mana(t3Cost)
    .register()
// Pride
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 1), item("botania:rune", 5), item("ee:infused_crystal"), item("factorytech:machinepart", 170), item("kami:ichorweave_fabric"))
    .output(item("botania:rune", 15))
    .mana(t3Cost)
    .register()

// Make Terrasteel cheaper
mods.botania_ceu.terrestrial_agglomeration_plate.removeByOutput(item("botania:manaresource", 4))
mods.botania_ceu.terrestrial_agglomeration_plate.recipeBuilder()
    .input(item("botania:manaresource"), item("botania:manaresource", 1), item("botania:manaresource", 2), item("roots:runic_dust"))
    .output(item("botania:manaresource", 4))
    .mana(250000)
    .register()
mods.botania_ceu.terrestrial_agglomeration_plate.recipeBuilder()
    .input(item("botania:manaresource"), item("botania:manaresource", 1), item("botania:manaresource", 2), item("appliedenergistics2:material", 45))
    .output(item("botania:manaresource", 4))
    .mana(75000)
    .centerBlock(blockstate("botania:alchemycatalyst"))
    .centerBlockReplacement(blockstate("botania:livingrock"))
    .cornerBlock(blockstate("gateway:crystalline_aerogel"))
    .cornerBlockReplacement(blockstate("aether_legacy:aerogel"))
    .register()
