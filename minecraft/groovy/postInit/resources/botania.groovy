...
// Lust
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 2), item("botania:rune", 4), item("minecraft:potion").withNbt(["Potion": "extrautils2:xu2.love"]), item("thaumcraft:tallow"))
    .output(item("botania:rune", 9))
    .mana(t3Cost)
    .register()
// Gluttony
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 3), item("botania:rune", 7), item("thermalfoundation:fertilizer", 2), item("botania:manacookie"))
    .output(item("botania:rune", 10))
    .mana(t3Cost)
    .register()
// Greed
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 2), item("botania:rune", 6), item("thermalfoundation:material", 134), item("minecraft:golden_apple", 1))
    .output(item("botania:rune", 11))
    .mana(t3Cost)
    .register()
// Sloth
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune"), item("botania:rune", 5), item("minecraft:potion").withNbt(["Potion": "minecraft:slowness"]), item("essentialcraft:genitem", 32))
    .output(item("botania:rune", 12))
    .mana(t3Cost)
    .register()
// Wrath
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 1), item("botania:rune", 7), item("soot:mug").withNbt(["Fluid": ["Amount": 250, "FluidName": "dwarven_ale"]]), item("netherized:netherite_sword"))
    .output(item("botania:rune", 13))
    .mana(t3Cost)
    .register()
// Envy
mods.botania.rune_altar.recipeBuilder()
    .input(terrasteel, item("botania:rune", 3), item("botania:rune", 4), item("essentialcraft:genitem", 55), item("essentialcraft:genitem", 22))
