...
mods.prodigytech.infusion.builder()
    .name("gold")
    .machine("solderer")
    .input(item("thermalfoundation:material", 97))
    .unlocalizedName("container.prodigytech.solderer.gold.ingots")
    .register()

mods.prodigytech.solderer.builder()
