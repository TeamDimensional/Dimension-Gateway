...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("praemunio") * 20, aspect("spiritus") * 20, aspect("bestia") * 20)
...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("aversio") * 50, aspect("tenebrae") * 50, aspect("sensus") * 25)
    .input(item("botania:rune", 1))
    .input(item("essentialcraft:genitem"))
    .input(item("essentialcraft:genitem"))
    .input(item("botania:rune", 5))
...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("volatus") * 20, aspect("potentia") * 20, aspect("aer") * 20)
...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("victus") * 20, aspect("ordo") * 20, aspect("alkimia") * 20)
    .input(item("essentialcraft:genitem", 22))
    .input(item("botania:rune", 4))
    .input(item("botania:rune", 6))
    .input(item("essentialcraft:genitem", 22))
    .input(item("essentialcraft:storage", 1))
    .instability(8)
    .register()
...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("machina") * 20, aspect("exanimis") * 20, aspect("vinculum") * 20)
...
mods.thaumcraft.infusion_crafting.recipeBuilder()
    ...
    .aspect(aspect("perditio") * 20, aspect("ignis") * 20, aspect("fabrico") * 20)
...
def foci = [
    ...
    [item("immersiveengineering:wooden_device1", 1), item("minecraft:potion").withNbt(["Potion":"minecraft:strength"]), "ignis", "potentia"],
    [item("minecraft:slime_ball"), item("minecraft:potion").withNbt(["Potion":"minecraft:regeneration"]), "victus", "praecantatio"],
    [item("immersiveengineering:wooden_device1", 1), item("minecraft:potion").withNbt(["Potion":"minecraft:haste"]), "aqua", "sensus"],
]
for (def i in 0..8) {
